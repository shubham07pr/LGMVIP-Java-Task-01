...
public class CurrencyConverter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        // Create the double border
//        Border outerBorder = BorderFactory.createLineBorder(new Color(0, 0, 0), 3);
//        Border innerBorder = BorderFactory.createLineBorder(new Color(0, 0, 0), 3);
//        Border spacingBorder = BorderFactory.createEmptyBorder(5, 5, 5, 5); // 5 pixels spacing on all sides
//        Border doubleBorder = new CompoundBorder(outerBorder, new CompoundBorder(spacingBorder, innerBorder));
//        pnlMain.setBorder(doubleBorder);

        lblTitle.setFont(new java.awt.Font("Ariel", 1, 24));
        lblTitle.setText("Currency Converter");

        cbSource.setFont(new java.awt.Font("Ariel", 1, 18));
        cbSource.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "From ...", "India", "Pakistan", "Japan", "China", "USA", "Canada", "Indonesia"}));
        ...
        cbTarget.setFont(new java.awt.Font("Ariel", 1, 18));
        cbTarget.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "To ...", "India", "Pakistan", "Japan", "China", "USA", "Canada", "Indonesia"}));
        ...
        txtSource.setFont(new java.awt.Font("Ariel", 1, 18));

        txtTarget.setFont(new java.awt.Font("Ariel", 1, 18));

        btnConvert.setFont(new java.awt.Font("Ariel", 1, 18));
        ...
        btnReset.setFont(new java.awt.Font("Ariel", 1, 18));
